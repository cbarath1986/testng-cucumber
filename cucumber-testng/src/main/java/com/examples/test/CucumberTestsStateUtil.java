            ...
            for (File testngTest : testngTests) {
                ...
                if (test.getAnnotation(Feature.class) != null) {
                    ...
                    for (Method method : test.getMethods()) {
                        if (method.getAnnotation(com.examples.test.annotation.Scenario.class) != null) {
                            String scenarioName = method.getAnnotation(com.examples.test.annotation.Scenario.class)
                                    .value();
